...
public class PacienteController {
	...
	public ResponseEntity<PacienteModel> GetById(@PathVariable String codPaciente){
		return re.findById(codPaciente).map(resp -> ResponseEntity.ok(resp)).orElse(ResponseEntity.notFound().build());
	}
	...
	@PostMapping
	public ResponseEntity <PacienteModel> Post(@RequestBody codPaciente paciente){
	...
	//put
	@PutMapping
	public ResponseEntity <PacienteModel> Put(@RequestBody codPaciente paciente){
	...
	//delete
	@DeleteMapping ("/paciente/{codPaciente}")
	public void delete(@PathVariable String  codPaciente) {
